...
int main(int argc, char* argv[]) {
    ...
    if(scen == 0){
        ...
        double g_TE_Lamb = g_TM_Lamb;
        double g_ME_Lamb = g_TM_Lamb;
        //diagonal coulping
        double g_TT_Lamb = atof(argv[4]);
        double g_MM_Lamb = g_TT_Lamb;
        double g_EE_Lamb = g_TT_Lamb;    
        
    std::cout << "mX:  " << mX << std::endl;
    std::cout << "g_AB_Lamb:  " << g_TE_Lamb << std::endl;
    std::cout << "g_CC_Lamb:  " << g_EE_Lamb << std::endl;
