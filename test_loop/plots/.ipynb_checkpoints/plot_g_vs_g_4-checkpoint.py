...
#scenario_4
title = r'$g_{\tau \mu}$ vs. $g_{\mu \mu} (Belle II)$'
...
#scenario_4
title = r'${\rm Br}(\tau \to X \, \mu)$ vs. $c\tau(X \longrightarrow \mu \, \bar{\mu}) (Belle II)$'
...
#scenario_4
title = r'${\rm Br}(\tau \to X \, \mu)$ vs. $c\tau(X \to \mu \, \bar{\mu}) (Belle II)$'
xlabel = r'$c\tau(X \longrightarrow \mu \, \bar{\mu})$ [m]'
ylabel = r'${\rm Br}(\tau \longrightarrow X \, \mu)$'
zlabel = r'$three_event$'
filename = "br_vs_ct_4_mod"
