...
plt.plot(ZipAndSort(data3,KEYS.index("ctau [m]: "),KEYS.index("prompt small_r efficiencies (ind.): "))[0], ZipAndSort(data3,KEYS.index("ctau [m]: "),KEYS.index("prompt small_r efficiencies (ind.): "))[1],'c-', label = '$r_{max} \: m_{X} = 0.5$GeV')
plt.plot(ZipAndSort(data2,KEYS.index("ctau [m]: "),KEYS.index("prompt small_r efficiencies (ind.): "))[0], ZipAndSort(data2,KEYS.index("ctau [m]: "),KEYS.index("prompt small_r efficiencies (ind.): "))[1],'r-', label = '$r_{max} \: m_{X} = 1.0$GeV')
plt.plot(ZipAndSort(data1,KEYS.index("ctau [m]: "),KEYS.index("prompt small_r efficiencies (ind.): "))[0], ZipAndSort(data1,KEYS.index("ctau [m]: "),KEYS.index("prompt small_r efficiencies (ind.): "))[1],'k-', label = '$r_{max} \: m_{X} = 1.5$GeV')
...
plt.plot(ZipAndSort(data3,KEYS.index("ctau [m]: "),KEYS.index("prompt small_r efficiencies (cum.): "))[0], ZipAndSort(data3,KEYS.index("ctau [m]: "),KEYS.index("prompt small_r efficiencies (cum.): "))[1],'c-', label = '$r_{max} \: m_{X} = 0.5$GeV')
plt.plot(ZipAndSort(data2,KEYS.index("ctau [m]: "),KEYS.index("prompt small_r efficiencies (cum.): "))[0], ZipAndSort(data2,KEYS.index("ctau [m]: "),KEYS.index("prompt small_r efficiencies (cum.): "))[1],'r-', label = '$r_{max} \: m_{X} = 1.0$GeV')
plt.plot(ZipAndSort(data1,KEYS.index("ctau [m]: "),KEYS.index("prompt small_r efficiencies (cum.): "))[0], ZipAndSort(data1,KEYS.index("ctau [m]: "),KEYS.index("prompt small_r efficiencies (cum.): "))[1],'k-', label = '$r_{max} \: m_{X} = 1.5$GeV')
