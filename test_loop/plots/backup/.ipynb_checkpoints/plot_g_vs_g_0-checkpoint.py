...
#plot signal
plot_logx_logy_logz(data1[:,1], xlabel, data1[:,2], ylabel, data1[:,27], zlabel, title, filename, 'k','-',r'$m_{X} = 1.5 \: \textrm{GeV}$', 3 , 1 ,[(0.8,5e-8)],'3signal')
plot_logx_logy_logz(data2[:,1], xlabel, data2[:,2], ylabel, data2[:,27], zlabel, title, filename, 'r','-',r'$m_{X} = 1.0 \: \textrm{GeV}$', 3 , 1 ,[(0.8,5e-8)],'3signal')
plot_logx_logy_logz(data3[:,1], xlabel, data3[:,2], ylabel, data3[:,27], zlabel, title, filename, 'c','-',r'$m_{X} = 0.5 \: \textrm{GeV}$', 3 , 1 ,[(0.8,5e-8)],'3signal')
