...
//functions
    ...
    double pseudoscalarGmWidth(double mPseudoscalar, double mlAlpha, double mlBeta, double mlGamma, double g_AlphaAlphaOverLamb, double g_BetaBetaOverLamb, double g_GammaGammaOverLamb);
    dcomp loopB1(double mlAlpha, double mPseudoscalar);
