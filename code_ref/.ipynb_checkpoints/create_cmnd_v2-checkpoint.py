...
fname = "/home/Storage/MG5_Study_Group/Cards/trail_2/SVJ_" + str(rinv) + "_" + str(lambdas) + ".cmnd"
# fname = "/home/Storage/MG5_Study_Group/Cards/0jet_FSR_fix_2/SVJ_" + str(rinv) + "_" + str(lambdas) + ".cmnd"
...
alpha_d = np.pi*2/((11./3.*2-2./3.*2)*np.log(1000./lambdas))
...
f.write('Init:showAllSettings = on  \n')
...
# f.write('HiddenValley:alphaFSR = ' +str(alpha_d)+' \n') 

## New Change 2020/08/12
...
# ## New Change 2020/08/12
# f.write('4900101:m0 = '+str(mass) +'\n')
# f.write('4900101:mWidth = '+ str(mass / 100)+ '\n')
# f.write('4900101:mMin = '+str(mass  - mass / 100)+'\n')
# f.write('4900101:mMax = '+str(mass  + mass / 100)+'\n')
...
f.write('Beams:LHEF = /home/Storage/MG5_Study_Group/sig_schannel_up2jets_wz_auto_md10/Events/run_02/unweighted_events.lhe \n') 
# f.write('Beams:LHEF = /home/Storage/MG5_Study_Group/sig_schannel_wz_fix_md10/Events/run_02/unweighted_events.lhe \n')
